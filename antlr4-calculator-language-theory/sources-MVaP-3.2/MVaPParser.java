...
public class MVaPParser extends Parser {
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ADD) | (1L << SUB) | (1L << MUL) | (1L << DIV) | (1L << MOD) | (1L << INF) | (1L << INFEQ) | (1L << SUP) | (1L << SUPEQ) | (1L << EQUAL) | (1L << NEQ) | (1L << FADD) | (1L << FSUB) | (1L << FMUL) | (1L << FDIV) | (1L << FINF) | (1L << FINFEQ) | (1L << FSUP) | (1L << FSUPEQ) | (1L << FEQUAL) | (1L << FNEQ) | (1L << ITOF) | (1L << FTOI) | (1L << RETURN) | (1L << POP) | (1L << DUP) | (1L << READ) | (1L << READF) | (1L << WRITE) | (1L << WRITEF) | (1L << PUSHSP) | (1L << PUSHFP) | (1L << PUSHI) | (1L << PUSHF) | (1L << PUSHG) | (1L << STOREG) | (1L << PUSHL) | (1L << STOREL) | (1L << PUSHR) | (1L << STORER) | (1L << FREE) | (1L << ALLOC) | (1L << CALL) | (1L << JUMP) | (1L << JUMPF) | (1L << JUMPR) | (1L << HALT) | (1L << LABEL) | (1L << NEWLINE))) != 0) );
			}
		}
	...
	public final Commande1Context commande1() throws RecognitionException {
		...
		try {
			...
			setState(43);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ADD) | (1L << SUB) | (1L << MUL) | (1L << DIV) | (1L << MOD) | (1L << INF) | (1L << INFEQ) | (1L << SUP) | (1L << SUPEQ) | (1L << EQUAL) | (1L << NEQ) | (1L << FADD) | (1L << FSUB) | (1L << FMUL) | (1L << FDIV) | (1L << FINF) | (1L << FINFEQ) | (1L << FSUP) | (1L << FSUPEQ) | (1L << FEQUAL) | (1L << FNEQ) | (1L << ITOF) | (1L << FTOI) | (1L << RETURN) | (1L << POP) | (1L << DUP) | (1L << READ) | (1L << READF) | (1L << WRITE) | (1L << WRITEF) | (1L << PUSHSP) | (1L << PUSHFP) | (1L << HALT))) != 0)) ) {
	...
	public final CommandeSautContext commandeSaut() throws RecognitionException {
		...
		try {
			...
			setState(58);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << CALL) | (1L << JUMP) | (1L << JUMPF) | (1L << JUMPR))) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public static final String _serializedATN =
		...
		"\2\2\f\2\4\6\b\n\f\16\20\22\24\2\5\4\2\6%\64\64\4\2&&(/\3\2\60\63\2B\2"+
		...
		"\65\5\n\6\2\65\66\7\4\2\2\66\67\b\7\1\2\67\r\3\2\2\289\7\'\2\29:\7\5\2"+
		"\2:;\b\b\1\2;\17\3\2\2\2<=\t\4\2\2=\21\3\2\2\2>?\5\20\t\2?@\7\66\2\2@"+
		"A\b\n\1\2A\23\3\2\2\2BC\7\65\2\2CD\7\66\2\2DE\b\13\1\2E\25\3\2\2\2\4\31"+
		"+";
